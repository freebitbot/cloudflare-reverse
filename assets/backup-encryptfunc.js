...
function cryptData(color, elem) {
    function f(item, i, d) {
        x = {}
        x.IWBEV =
            'G7Ttuo4rxW6mUa+k2C5eQhN$pqEM8gyFVfcZBSA3dlvRDnY9bPOziwHXJjI-1s0LK'
        x.YZHcU = function (progressOld, progressNew) {
            return progressOld < progressNew
        }
        x.YjAfQ = function (name, initialValue) {
            return name === initialValue
        }
        x.qDpRl = 'SZSSH'
        x.fOTVL = function (loaded, total) {
            return loaded > total
        }
        x.uQsHx = function (x, y) {
            return x < y
        }
        x.qvVdy = function (fun, obj) {
            return fun(obj)
        }
        x.oCnYT = function (leftDiags, columns) {
            return leftDiags | columns
        }
        x.cbqgM = function (_left, _right) {
            return _left << _right
        }
        x.ZRTzU = function (data, type) {
            return data == type
        }
        x.tcoyh = function (fractionalPosition, type) {
            return fractionalPosition > type
        }
        x.gPlDx = function (h, i) {
            return h - i
        }
        x.moDPL = function (fn, useBinaryString) {
            return fn & useBinaryString
        }
        x.AqyRT = function (replacement, css) {
            return replacement(css)
        }
        x.SPMAy = 'myPvT'
        x.oWFwx = function (_left, _right) {
            return _left << _right
        }
        x.tHnDI = function (h, i) {
            return h - i
        }
        x.spysu = function (name, requiredFrom) {
            return name == requiredFrom
        }
        x.nJDoD = function (fun, obj) {
            return fun(obj)
        }
        x.HBUgW = function (_left, _right) {
            return _left << _right
        }
        x.POcMj = function (name, requiredFrom) {
            return name == requiredFrom
        }
        x.Ygywr = function (fun, obj) {
            return fun(obj)
        }
        x.dIgEk = function (name, days) {
            return name == days
        }
        x.IAfOy = function (h, i) {
            return h - i
        }
        x.ifVeK = function (name, days) {
            return name == days
        }
        x.bgpVs = function (x, y) {
            return x < y
        }
        x.BvcjQ = function (leftDiags, columns) {
            return leftDiags | columns
        }
        x.aJbCM = function (h, i) {
            return h - i
        }
        x.Kohxo = function (require, load, callback) {
            return require(load, callback)
        }
        x.cfhxF = function (name, requiredFrom) {
            return name == requiredFrom
        }
        x.evHkj = function (saveNotifs, notifications) {
            return saveNotifs(notifications)
        }
        x.VXmYP = '0|2|3|1|4'
        x.fpfvZ = function (dest_operand, source_operand) {
            return dest_operand & source_operand
        }
        x.iRcdr = function (saveNotifs, notifications) {
            return saveNotifs(notifications)
        }
        x.fgEaY = function (state, connected) {
            return state != connected
        }
        x.WygCs = function (state, connected) {
            return state != connected
        }
        x.tLJsT = function (_num1, _num2) {
            return _num1 > _num2
        }
        x.LLnfV = function (state, connected) {
            return state != connected
        }
        x.YFjrm = function (mmCoreSecondsDay, daysInterval) {
            return mmCoreSecondsDay * daysInterval
        }
        x.sruAF = function (state, connected) {
            return state != connected
        }
        x.bpgDm = function (mmCoreSecondsDay, daysInterval) {
            return mmCoreSecondsDay * daysInterval
        }
        x.GVYGr = function (saveNotifs, notifications) {
            return saveNotifs(notifications)
        }
        x.CUGNc = function (connectNumber, concurency) {
        ...
        A = {
            g: function (
                ...
                value = 0
                val = 0
                for (; y.YZHcU(val, b.length); val = val + 1) {
                    if (
                        ((i = b.charAt(val)),
                            Object.prototype.hasOwnProperty.call(obj, i) ||
                            ((obj[i] = id++), (props[i] = true)),
                            (name = key + i),
                            Object.prototype.hasOwnProperty.call(obj, name))
                    ) {
                        key = name
                    } else {
                        if (y.YjAfQ('EknFQ', y.qDpRl)) {
                            var xdrFetch = function () {
                                p.timeout = 2500
                                t.ontimeout = function () {}
                            }
                        } else {
                            code = '0|2|4|1|3'.split('|')
                            index = 0
                            for (; true;) {
                                switch (code[index++]) {
                                case '0':
                                    if (Object.prototype.hasOwnProperty.call(props, key)) {
                                        if (y.fOTVL(256, key.charCodeAt(0))) {
                                            o = 0
                                            for (; y.uQsHx(o, p); data = data << 1,
                                                value == x - 1 ?
                                                ((value = 0),
                                                    t.push(y.qvVdy(h, data)),
                                                    (data = 0)) :
                                                value++,
                                                o++
                                            ) {}
                                            e = key.charCodeAt(0)
                                            o = 0
                                            for (; 8 > o; data = y.oCnYT(y.cbqgM(data, 1), e & 1),
                                                value == x - 1 ?
                                                ((value = 0), t.push(h(data)), (data = 0)) :
                                                value++,
                                                e = e >> 1,
                                                o++
                                            ) {}
                                            ...
                                            e = key.charCodeAt(0)
                                            o = 0
                                            for (; y.tcoyh(16, o); data = y.cbqgM(data, 1) | (e & 1),
                                                value == y.gPlDx(x, 1) ?
                                                ((value = 0), t.push(h(data)), (data = 0)) :
                                                value++,
                                                e = e >> 1,
                                        ...
                                        e = obj[key]
                                        o = 0
                                        for (; y.uQsHx(o, p); data = (data << 1) | y.moDPL(e, 1),
                                            y.ZRTzU(value, x - 1) ?
                                            ((value = 0),
                                                t.push(y.AqyRT(h, data)),
                                                (data = 0)) :
                                            value++,
                                            e = e >> 1,
                                            o++
                ...
                if ('' !== key) {
                    if (y.SPMAy === 'AsmIU') {
                        ...
                        if (Object.prototype.hasOwnProperty.call(props, key)) {
                            if (256 > key.charCodeAt(0)) {
                                o = 0
                                for (; y.uQsHx(o, p); data = data << 1,
                                    value == x - 1 ?
                                    ((value = 0), t.push(y.AqyRT(h, data)), (data = 0)) :
                                    value++,
                                    o++
                                ) {}
                                e = key.charCodeAt(0)
                                o = 0
                                for (; y.tcoyh(8, o); data = y.oWFwx(data, 1) | (e & 1),
                                    y.ZRTzU(value, y.tHnDI(x, 1)) ?
                                    ((value = 0), t.push(y.AqyRT(h, data)), (data = 0)) :
                                    value++,
                                    e = e >> 1,
                                    o++
                                ...
                                for (; o < p; data = (data << 1) | e,
                                    y.spysu(value, x - 1) ?
                                    ((value = 0), t.push(y.nJDoD(h, data)), (data = 0)) :
                                    value++,
                                    e = 0,
                                    o++
                                ) {}
                                e = key.charCodeAt(0)
                                o = 0
                                for (; 16 > o; data = y.HBUgW(data, 1) | (e & 1),
                                    y.POcMj(value, x - 1) ?
                                    ((value = 0), t.push(y.Ygywr(h, data)), (data = 0)) :
                                    value++,
                                    e = e >> 1,
                                    o++
                                ) {}
                            ...
                            e = obj[key]
                            o = 0
                            for (; y.uQsHx(o, p); data = y.HBUgW(data, 1) | (e & 1),
                                y.dIgEk(value, y.IAfOy(x, 1)) ?
                                ((value = 0), t.push(y.Ygywr(h, data)), (data = 0)) :
                                value++,
                                e = e >> 1,
                                o++
                ...
                e = 2
                o = 0
                for (; y.bgpVs(o, p); data = y.BvcjQ(y.HBUgW(data, 1), y.moDPL(e, 1)),
                    value == x - 1 ?
                    ((value = 0), t.push(h(data)), (data = 0)) :
                    value++,
                    e = e >> 1,
                ...
                for (;;) {
                    if (((data = data << 1), value == y.aJbCM(x, 1))) {
                        t.push(h(data))
                        break
                    } else {
                        value++
