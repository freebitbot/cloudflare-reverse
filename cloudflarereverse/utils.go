...
func formatFingerprint(fp *fpclient.Fingerprint) string {
	fps := map[string][]string{
		...
		fmt.Sprintf("%d", fp.Window.OuterHeight): []string{
			"outerHeight",
		},
		fmt.Sprintf("%d", fp.Window.OuterWidth): []string{
			"outerWidth",
		},
		"N": []string{
			"AbortController",
		...
		fmt.Sprintf("%d", fp.Window.DevicePixelRatio): []string{
			"devicePixelRatio",
		},
		"u": []string{
			"event",
		...
		"https://discord.com": []string{
			"origin",
		},
		fp.Navigator.AppCodeName: []string{
			"n.appCodeName",
		},
		fp.Navigator.AppName: []string{
			"n.appName",
		},
		fp.Navigator.AppVersion: []string{
			"n.appVersion",
		},
		fp.Navigator.Language: []string{
			"n.language",
		},
		strings.Join(fp.Navigator.Languages, ","): []string{
			"n.languages",
		},
		fp.Navigator.Platform: []string{
			"n.platform",
		},
		fp.Navigator.Product: []string{
			"n.product",
		},
		fp.Navigator.UserAgent: []string{
			"n.userAgent",
		},
		fp.Navigator.Vendor: []string{
			"n.vendor",
		},
		"about:blank": []string{
			"d.URL",
		...
		time.Now().Format("01/02/2006 15:04:05"): []string{
			"d.lastModified",
		},
		"#document": []string{
			"d.nodeName",
